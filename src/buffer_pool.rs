...
#[derive(Debug, thiserror::Error)] // ToDo:thiserrorクレートの理解
pub enum Error {
    #[error(transparent)]
    Io(#[from] io::Error),
...
#[derive(Debug, Default, Clone, Copy, Eq, PartialEq, Hash)] // ToDo:Deriveの理解
...
impl BufferPool {
    // Clock-sweep: バッファプール内のすべてのバッファを巡回して捨てるバッファを決定
